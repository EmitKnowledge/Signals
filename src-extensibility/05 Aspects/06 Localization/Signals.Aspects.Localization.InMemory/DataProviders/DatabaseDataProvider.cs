...
namespace Signals.Aspects.Localization.InMemory.DataProviders
{
    public class DatabaseDataProvider : ILocalizationDataProvider
    {
        private DatabaseDataProviderConfiguration Configuration { get; set; }
        ...
        public void InsertLocalizationKey(LocalizationKey localizationKey)
        {
            ...
            {
                connection.Open();
                var sql = $"INSERT INTO dbo.[{Configuration.LocalizationKeyTableName}]([Name]) VALUES('{localizationKey.Name}')";
                var command = new SqlCommand(sql, connection);
            ...
            using (var connection = new SqlConnection(Configuration.ConnectionString))
            {
                ...
                var sql =
                    $@"
                        ...
                        SET
                            Name = '{localizationCollection.Name}',
                        ...
                        VALUES('{localizationCollection.Name}', {localizationCollection.LocalizationCategoryId})
                    ";
                var command = new SqlCommand(sql, connection);
                command.ExecuteNonQuery();
            }
            ...
            using (var connection = new SqlConnection(Configuration.ConnectionString))
            {
                ...
                var sql =
                    $@"
                        ...
                        VALUES('{entry.Value}', {entry.LocalizationCollectionId}, {entry.LocalizationKeyId}, {entry.LocalizationLanguageId})
                    ";
                var command = new SqlCommand(sql, connection);
                command.ExecuteNonQuery();
            }
                    ...
                    var entrySql =
                        $@"
                            IF EXISTS (SELECT * FROM dbo.[{Configuration.LocalizationEntryTableName}] le WHERE le.LocalizationKeyId = {localizationEntry.LocalizationKeyId} AND le.LocalizationLanguageId = {localizationEntry.LocalizationLanguageId})
                                UPDATE dbo.[{Configuration.LocalizationEntryTableName}]
                                SET LocalizationCollectionId = {localizationEntry.LocalizationCollectionId}, LocalizationKeyId = {localizationEntry.LocalizationKeyId}, LocalizationLanguageId = {localizationEntry.LocalizationLanguageId}, Value = '{localizationEntry.Value}'
                            ...
                            ELSE
                                ...
                                VALUES ({localizationEntry.LocalizationKeyId}, {localizationEntry.LocalizationCollectionId}, {localizationEntry.LocalizationLanguageId}, '{localizationEntry.Value}')
                        ";
