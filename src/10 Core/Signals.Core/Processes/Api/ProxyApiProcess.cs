...
{
	/// <summary>
	/// ProxyApiProcess expose a business process as an API endpoint.
	/// For simple CRUD based processes, ProxyApiProcess do the execution. 
	/// The developer needs to provide mapping from DTO to business process args and a mapping from business process result to API result. 
	/// </summary>	
