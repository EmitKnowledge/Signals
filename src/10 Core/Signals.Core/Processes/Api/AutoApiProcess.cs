...
{
	/// <summary>
	/// AutoApiProcess expose a business process as an API endpoint.
	/// For simple CRUD based processes, AutoApiProcess do the execution. 
	/// The developer needs to provide mapping from DTO to business process args.
	/// The results from the business process will be returned as it is.
	/// </summary>
